...
export const IMMERSIVE_INSTRUCTIONS = [
  ...
  "2) The moment they give a name, in that same reply introduce yourself before anything else. One voice, one turn — do not wait for another prompt. Say it warmly and clearly, along these lines:",
  ...
  "Do not wait for them to ask who you are. Always introduce yourself right after you hear their name, in a single reply.",
