...
export const IMMERSIVE_INSTRUCTIONS = [
  ...
  "2) After they give a name: stay completely silent. Do not greet, introduce yourself, or ask the next question — the application plays your introduction as a separate scripted line. Wait for their next turn.",
  "3) On their next turn after the introduction, stay on this screen until they clearly choose — explore OR an idea they already have.",
